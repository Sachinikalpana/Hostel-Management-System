...
<head>
  ...
  <title>My Complaints - Security</title>
...
<div class="container" style="padding: 30px;">
  <div class="page-header">
    <h1>My Complaints</h1>
    <p>Submit and track your security concerns</p>
  </div>
  ...
  <div class="dashboard-section">
    ...
    <form method="post">
      <div class="form-group">
        ...
        <input type="number" name="room_number" min="0" max="100" class="form-control" placeholder="Enter room number if applicable">
      </div>
      <div class="form-group">
        <label>Complaint Details</label>
        <textarea name="complaint" rows="5" required class="form-control" placeholder="Describe the security concern..."></textarea>
      </div>
        ...
        <tbody>
          <?php if($complaints_result && $complaints_result->num_rows > 0): ?>
            ...
            <tr>
              ...
              <td><?php echo $complaint['room_number'] > 0 ? 'Room ' . $complaint['room_number'] : 'General'; ?></td>
